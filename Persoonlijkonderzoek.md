...
- [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Using_files_from_web_applications)
- [Chris Geelhoed]( https://www.geelhoed.dev/nodejs/express/file-upload/)
- [Laravel Documentation](https://laravel.com/docs/8.x/eloquent-mutators#file-uploads)
- [Mukesh Mururgan](https://codewithmukesh.com/blog/file-upload-in-database-aspnet-core/)
- [Amazon Web Services]( https://docs.aws.amazon.com/AmazonS3/latest/dev/Welcome.html)
